            ...
            if len(BB3_f1) >= (0.9 * BB3_len) and len(BB2_f1) >= (0.9 * BB2_len):
                ...
                for Tag2 in BB2_f1:
                    ...
                    if BB3_f2 >= (0.8 * BB3_len):
                        count_f_filter.loc[(count_f_filter['TAG1'] == Tag1) & (count_f_filter['TAG3'] == Tag2),'TAG1_DLP'] = str(1.24)
                        # 判断线，很明显的线.1.21：1表示tag1,2表示线，1表示线明显程度。明显程度逐渐递增（0,1,2）
                    elif BB3_f2 >= (0.8 * len(BB3_f1)):
                        count_f_filter.loc[(count_f_filter['TAG1'] == Tag1) & (count_f_filter['TAG3'] == Tag2),'TAG1_DLP'] = str(1.23)
                        # 判断线，相对没那么明显的线
            ...
            # 如果面和线都不明显，一条线上只有3个点或以上时，DLP对应的值都为零时，缩小条件重新判定点线面
                ...
                if len(BB2_f1) >= max(3, 0.2*BB1_f1) and len(BB3_f1) >= max(3, 0.2*BB1_f1):
                    ...
                    for Tag2 in BB2_f1:
                        ...
                        if BB3_f3 >= 3:
                            count_f_filter.loc[(count_f_filter['TAG1'] == Tag1) & (count_f_filter['TAG3'] == Tag2), 'TAG1_DLP'] = str(1.21)
                        else:
                            count_f_filter.loc[(count_f_filter['TAG1'] == Tag1) & (count_f_filter['TAG3'] == Tag2), 'TAG1_DLP'] = str(1.20)
        ...
        if BB2_f1 == 1:
            ...
            if len(BB3_f1) >= (0.9 * BB3_len) and len(BB1_f1) >= (0.9 * BB1_len):
                ...
                for Tag1 in BB1_f1:
                    ...
                    # 当BB1和BB2固定时，判断BB3的个数
                    if BB3_f2 >= (0.8 * BB3_len):
                        count_f_filter.loc[(count_f_filter['TAG3'] == Tag2) & (count_f_filter['TAG1'] == Tag1),'TAG3_DLP'] = str(3.24)
                        # 判断线，很明显的线.2.21：2表示tag2,2表示线，1表示线明显程度。明显程度逐渐递增（0,1,2）
                    elif BB3_f2 >= (0.8 * len(BB3_f1)):
                        count_f_filter.loc[(count_f_filter['TAG3'] == Tag2) & (count_f_filter['TAG1'] == Tag1),'TAG3_DLP'] = str(3.23)
                        # 判断线，相对没那么明显的线
                    ...
                    for Tag1 in BB1_f1:
                        ...
                        if BB3_f3 >= 3:
                            count_f_filter.loc[(count_f_filter['TAG3'] == Tag2) & (
                                        count_f_filter['TAG1'] == Tag1), 'TAG3_DLP'] = str(3.21)
                        else:
                            count_f_filter.loc[(count_f_filter['TAG3'] == Tag2) & (
                                        count_f_filter['TAG1'] == Tag1), 'TAG3_DLP'] = str(3.20)
