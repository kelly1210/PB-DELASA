# -*- coding: utf-8 -*-
"""
Created on Wed Mar  3 16:07:34 2021
...
def offDNAmain(dlpfile,offDNAtempfile,sample_info,sample_dir,dotNumber):
    # dotNumber表示线或面的情况下，根据dedup_counts输出几个点，设为1，则只输出最大值对应的点
...
def main():
    ...
    offDNAmain(args.Input,OutputtempDNA,args.SampleInfo,args.Analysis,'20')
